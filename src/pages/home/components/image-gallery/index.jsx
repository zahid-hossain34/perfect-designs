...
const ImageGallery = () => {
  return (
    <Wrapper className="mt-16 min-h-screen sm:mt-24 md:mt-32">
      <div className="masonry">
        <div className="tall">
          <img loading="lazy" src={Image1} alt="collection" />
          <p>Hospitality Uniform</p>
        </div>

        <div className="tall">
          <img loading="lazy" src={Image2} alt="collection" />
          <p>Hospitality Uniform</p>
        </div>

        <div className="wide black-text">
          <img loading="lazy" src={Image3} alt="collection" />
          <p>Hospitality Uniform</p>
        </div>

        <div className="tall">
          <img loading="lazy" src={Image4} alt="collection" />
          <p>Hospitality Uniform</p>
        </div>

        <div className="tall">
          <img loading="lazy" src={Image5} alt="collection" />
          <p>Restaurant Uniform</p>
        </div>

        <div className="big">
          <img loading="lazy" src={Image6} alt="collection" />
          <p>Restaurant Uniform</p>
        </div>

        <div className="wide">
          <img loading="lazy" src={Image7} alt="collection" />
          <p>Restaurant Uniform</p>
        </div>

        <div className="tall">
          <img loading="lazy" src={Image8} alt="collection" />
          <p>Restaurant Uniform</p>
        </div>

        <div className="tall">
          <img loading="lazy" src={Image9} alt="collection" />
          <p>Healthcare Uniform</p>
        </div>

        <div className="wide">
          <img loading="lazy" src={Image10} alt="collection" />
          <p>Healthcare Uniform</p>
        </div>

        <div className="wide">
          <img loading="lazy" src={Image11} alt="collection" />
          <p>Healthcare Uniform</p>
        </div>

        <div className="big">
          <img loading="lazy" src={Image12} alt="collection" />
          <p>Healthcare Uniform</p>
        </div>

        <div className="wide">
          <img loading="lazy" src={Image14} alt="collection" />
          <p>Construction Uniform</p>
        </div>

        <div className="big">
          <img loading="lazy" src={Image15} alt="collection" />
          <p>Construction Uniform</p>
        </div>

        <div className="wide">
          <img loading="lazy" src={Image16} alt="collection" />
          <p>Construction Uniform</p>
        </div>

        <div className="tall">
          <img loading="lazy" src={Image17} alt="collection" />
          <p>Corporate Uniform</p>
        </div>

        <div className="tall">
          <img loading="lazy" src={Image18} alt="collection" />
          <p>Corporate Uniform</p>
        </div>

        <div className="big">
          <img loading="lazy" src={Image19} alt="collection" />
          <p>Corporate Uniform</p>
        </div>

        <div className="tall">
          <img loading="lazy" src={Image20} alt="collection" />
          <p>Corporate Uniform</p>
        </div>
      </div>
    </Wrapper>
